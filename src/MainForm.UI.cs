...
public partial class MainForm : Form {
    ...
    void AddActivitySettings(FlowLayoutPanel opts){
        opts.Controls.Add(Label("던전 · 사냥터 알림",14));var bar=Bar();bar.Dock=DockStyle.None;
