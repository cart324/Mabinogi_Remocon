...
public partial class MainForm {
    ...
    void EditGoal(Goal old){
        ...
        using(var d=new EditDialog("자동 가공 목표")){
            d.Height=720;var facilityChoice=Combo(480);Fill(facilityChoice,Facilities.Names,facility);var recipe=Combo(480);var all=new CheckBox{Text="전체 가공법 보기 (기본 분류가 다를 때)",AutoSize=true};
